...
$query = "DELETE FROM subjects_tour_tasks where id='$id'";
...
$tquery = "DROP TABLE tour_$id";
mysql_query($tquery);
echo $tquery;
echo  mysql_error();

$squery = "DROP TABLE tour_state_$id";
mysql_query($squery);
echo $squery;
echo  mysql_error();

$uquery = "DROP TABLE tour_users_$id";
mysql_query($uquery);
echo $uquery;
echo  mysql_error();

$timequery = "UPDATE tour_subjects SET createTime=NULL WHERE tid='$id'";
mysql_query($timequery);
echo mysql_error();

// assign the id to the task subject 
$idquery = "UPDATE tour_subjects SET tid=NULL WHERE tid='$id'";
echo $idquery;
mysql_query($idquery);
echo mysql_error();
