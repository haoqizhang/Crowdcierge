...
$taskId = '13369e9c767f9998f5b824fcea036bf8';
...
while($row = mysql_fetch_array($results, MYSQL_ASSOC)) {
    ...
    $to = $row['email'];
    $subject = "Harvard visit planning ends Sunday, 5PM";
    $userId = $row['userId'];
    $name = explode(" ", $row['name']);
    $name = $name[0];

    $body = "Hi $name,\n\nHappy Saturday! Just a reminder that the current mobi tour for a Harvard visit ends this Sunday at 5pm. Please feel free to make additional edits before then!";
    ...
    $html = file_get_contents("reminderemail.html");
