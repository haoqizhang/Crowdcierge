...
$taskId = 'e21342b2ae06463a400a62b094872a73';
...
while($row = mysql_fetch_array($results, MYSQL_ASSOC)) {
    ...
    $from = "Mobi Boston Outing <hq@eecs.harvard.edu>";
    $to = $row['email'];
    //$to = $email;
    $subject = "Boston outing planning ends Sunday, 5PM";
    $userId = $row['userId'];
    $name = explode(" ", $row['name']);
    $name = $name[0];

    $body = "Hi $name,\n\nHappy Friday! Just a reminder that the planning for the ultimate Boston outing ends this Sunday at 5pm. Please feel free to make additional edits before then!";
    ...
    $html = file_get_contents("bostonreminder.html");
