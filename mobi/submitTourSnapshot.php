...
if(strcmp("tour", $type) == 0){
  ...
  $query = "INSERT INTO tour_state_$taskId (state, userId, submitTime, changeInfo) VALUES ('$answer', '$userId', now(), 'snapshot')";
  ...
  // send email with it
    ...
    $to = $requesteremail;
    $subject = "A snapshot of your Mobi itinerary (with help from your friends)";
    $name = explode(" ", $requestername);
    $name = $name[0];

    $body = "Hi $name,\n\n We have saved a snapshot of your itinerary (with help from your friends) for you!\n\n Best,\n Mobi admin";
    ...
    $html = file_get_contents("subjectfriendsnapshotemail.html");
