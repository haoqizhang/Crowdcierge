...
function generatePredicate(constraintDesc){
	...
	if(compare == 'at most'){
	    if(unit=='hours'){
		return new predicateResponse(total <= v, total, activities, "Too much time on '" + printCat(cat) + "' in the itinerary");
	    }else if(unit=='activities'){
		return new predicateResponse(total <= v, total, activities, "Have too many '" + printCat(cat) + "' activities in the itinerary");
	    }
	}else if(compare == 'at least'){
	    if(unit=='hours'){
		return new predicateResponse(total >= v, total, activities, "Add more '" + printCat(cat) + "' to the itinerary");
	    }else if(unit=='activities'){
		return new predicateResponse(total >= v, total, activities, "Add more '" + printCat(cat) + "' to the itinerary");
	    }
